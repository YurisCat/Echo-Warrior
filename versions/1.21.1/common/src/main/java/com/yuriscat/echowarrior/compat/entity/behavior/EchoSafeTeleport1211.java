...
public final class EchoSafeTeleport1211 {
	...
	public static boolean teleportBesideOwner(PathfinderMob echo, LivingEntity owner) {
		...
		echo.moveTo(destination.x, destination.y, destination.z, yaw, 0.0F);
	...
	public static Vec3 findSafeDestination(ServerLevel level, PathfinderMob echo, LivingEntity owner) {
