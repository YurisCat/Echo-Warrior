...
public final class EchoAccessoryItem1211 extends Item implements EchoSummonerAccessory1211 {
    ...
    public EchoAccessoryItem1211(Properties properties, AccessoryType type) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        for (int index = 0; index < this.type.effectCount(); index++) {
            boolean positive = this.type.effectIsPositive(index);
            int color = positive ? POSITIVE_COLOR : NEGATIVE_COLOR;
            tooltip.add(Component.literal(positive ? "+" : "-")
        ...
        if (!TooltipShiftState1211.isShiftDown()) {
            tooltip.add(Component.translatable("item.echo_warrior.accessory.more_hint")
        ...
        tooltip.add(detailLine("item.echo_warrior.accessory.detail.equip", summoner, echo));
        tooltip.add(detailLine("item.echo_warrior.accessory.detail.unique", accessory));
    }
    ...
    public enum AccessoryType {
        ...
        FRACTURED_CRYSTAL_BLADE("fractured_crystal_blade", Rarity.COMMON, EffectPolarity.POSITIVE, EffectPolarity.NEGATIVE),
        TWIN_OATH_BADGE("twin_oath_badge", Rarity.UNCOMMON, EffectPolarity.POSITIVE, EffectPolarity.POSITIVE),
        BATTLE_BLINDFOLD("battle_blindfold", Rarity.COMMON, EffectPolarity.POSITIVE, EffectPolarity.NEGATIVE),
        ...
        MEMORY_RITUAL_KNIFE("memory_ritual_knife", Rarity.UNCOMMON, EffectPolarity.POSITIVE, EffectPolarity.POSITIVE),
        SUBSTITUTE_DOLL("substitute_doll", Rarity.RARE, EffectPolarity.POSITIVE),
        ...
        PEACEMAKER("peacemaker", Rarity.UNCOMMON, EffectPolarity.POSITIVE, EffectPolarity.NEGATIVE),
        ...
        TRAINING_NOTES("training_notes", Rarity.COMMON, EffectPolarity.POSITIVE, EffectPolarity.NEGATIVE),
        ...
        HOLLOW_BIRD_BONE("hollow_bird_bone", Rarity.COMMON, EffectPolarity.POSITIVE, EffectPolarity.NEGATIVE);

        private final String id;
        private final Rarity rarity;
        private final List<EffectPolarity> effects;
