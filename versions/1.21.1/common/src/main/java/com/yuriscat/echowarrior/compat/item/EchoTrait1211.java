...
public enum EchoTrait1211 {
    ...
    EchoTrait1211(int bit, String id) {
        this.bit = bit;
        this.translationKey = "trait.echo_warrior." + id;
    }

    public int mask() { return 1 << this.bit; }
    public String id() { return this.translationKey.substring("trait.echo_warrior.".length()); }
    public String nameTranslationKey() { return this.translationKey + ".name"; }
    public String descriptionTranslationKey() { return this.translationKey + ".description"; }

    public boolean conflictsWith(EchoTrait1211 other) {
    ...
    private static boolean isCreatureSlayer(EchoTrait1211 trait) {
        return trait == UNDEAD_SLAYER || trait == ARTHROPOD_SLAYER || trait == RAIDER_SLAYER;
    }

    private static boolean isRealmReaper(EchoTrait1211 trait) {
