...
/** 1.21.1 renderer-side gaze, blink and expression bridge for the Guandao warrior. */
public final class GuandaoWarriorModel1211 extends GeoModel<GuandaoWarriorEchoEntity1211> {
    private static final ResourceLocation MODEL = ModContent1211.id(
            "geo/guandao_warrior_echo.geo.json");
    private static final ResourceLocation TEXTURE = ModContent1211.id(
            "textures/entity/guandao_warrior_echo.png");
    private static final ResourceLocation ANIMATION = ModContent1211.id(
            "animations/guandao_warrior_echo.animation.json");
    private final Map<Integer, VisualState> visualStates = new HashMap<>();

    @Override public ResourceLocation getModelResource(GuandaoWarriorEchoEntity1211 entity) { return MODEL; }
    @Override public ResourceLocation getTextureResource(GuandaoWarriorEchoEntity1211 entity) { return TEXTURE; }
    @Override public ResourceLocation getAnimationResource(GuandaoWarriorEchoEntity1211 entity) { return ANIMATION; }

    @Override
    public void setCustomAnimations(GuandaoWarriorEchoEntity1211 entity, long instanceId,
                                    AnimationState<GuandaoWarriorEchoEntity1211> animationState) {
        ...
        boolean locomotion = reaction == GuandaoWarriorEchoEntity1211.VISUAL_LOCOMOTION;
        ...
        float desiredTilt = reaction == GuandaoWarriorEchoEntity1211.VISUAL_CURIOUS
                ? entity.getCuriousTilt() * 10.0F : 0.0F;
        float responsiveness = reaction == GuandaoWarriorEchoEntity1211.VISUAL_STARTLED
                || reaction == GuandaoWarriorEchoEntity1211.VISUAL_HURT ? 0.55F
                : reaction == GuandaoWarriorEchoEntity1211.VISUAL_CAUGHT ? 0.36F
        ...
        float blink = reaction == GuandaoWarriorEchoEntity1211.VISUAL_STARTLED ? 0.0F
                : reaction == GuandaoWarriorEchoEntity1211.VISUAL_HURT
