...
/** 1.21.1 renderer-side gaze, blink and expression bridge for the Aztec warrior. */
public final class AztecWarriorModel1211 extends GeoModel<AztecWarriorEchoEntity1211> {
    private static final ResourceLocation MODEL = ModContent1211.id(
            "geo/aztec_warrior_echo.geo.json");
    private static final ResourceLocation TEXTURE = ModContent1211.id(
            "textures/entity/aztec_warrior_echo.png");
    private static final ResourceLocation ANIMATION = ModContent1211.id(
            "animations/aztec_warrior_echo.animation.json");
    private final Map<Integer, VisualState> visualStates = new HashMap<>();

    @Override public ResourceLocation getModelResource(AztecWarriorEchoEntity1211 entity) { return MODEL; }
    @Override public ResourceLocation getTextureResource(AztecWarriorEchoEntity1211 entity) { return TEXTURE; }
    @Override public ResourceLocation getAnimationResource(AztecWarriorEchoEntity1211 entity) { return ANIMATION; }

    @Override
    public void setCustomAnimations(AztecWarriorEchoEntity1211 entity, long instanceId,
                                    AnimationState<AztecWarriorEchoEntity1211> animationState) {
        ...
        boolean locomotion = reaction == AztecWarriorEchoEntity1211.VISUAL_LOCOMOTION;
        ...
        float desiredTilt = reaction == AztecWarriorEchoEntity1211.VISUAL_CURIOUS
                ? entity.getCuriousTilt() * 10.0F : 0.0F;
        float responsiveness = reaction == AztecWarriorEchoEntity1211.VISUAL_STARTLED
                || reaction == AztecWarriorEchoEntity1211.VISUAL_HURT ? 0.55F
                : reaction == AztecWarriorEchoEntity1211.VISUAL_CAUGHT ? 0.36F
        ...
        float blink = reaction == AztecWarriorEchoEntity1211.VISUAL_STARTLED ? 0.0F
                : reaction == AztecWarriorEchoEntity1211.VISUAL_HURT
